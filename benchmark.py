...
card_content = [
    ...
    dbc.CardBody(
        [
            html.H5("Card title", className="card-title", id="card-title"),
            html.P(
...
bench_layout = dbc.Container([
    ...
    html.H4('Select a Model',className="navigation-list-new "),
    dcc.Dropdown(
        options=[
            {'label': 'RFR', 'value': 'rfr'},
...
def update_card_content(value):
    if value == "rfr":
        ...
        text = "This is the card content for RANDOM FOREST"
        print('rfr')
    elif value == "var":
        title = "Varima"
        text = "This is the card content for VARIMA"
        print('var')
    else:
        title = "DCRNN"
